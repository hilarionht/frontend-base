  ...
  styles: [
    `
      ...
      .gc-card {
        ...
        /* Bootstrap .card-body usa --bs-card-spacer-* que solo se definen en .card.
           Al usar .gc-card como wrapper las variables son undefined → padding: 0.
           Se definen aquí para restaurar el padding esperado. */
